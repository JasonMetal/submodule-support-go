...
replace (
	gitee.com/JasonMetal/submodule-services-proto.git v0.0.0 => ../services-proto.git
	gitee.com/JasonMetal/submodule-support-go.git v0.0.0 => ../support-go.git
)

require (
	gitee.com/JasonMetal/submodule-support-go.git v0.0.0
